    ...
    def _send_short_summary(self, row: ZoomRecording) -> int:
        ...
        try:
            ...
            if url and has_summary and not has_body:
                # FR-CR-05-160 — content-free summary (Whisper
                # hallucination / silent audio → header + «Участники:»
                # only). Don't forward junk to the consumer. 2026-06-03
                # «Design Status / SDF / Алина, Ирина» regression.
                log.warning(
