...
_SYSTEM = (
    ...
    "- CONSISTENCY: if several mentions are phonetic variants of the SAME "
    "real-world entity (e.g. «мирая» and «Альмирая» are both Mirae), return the "
    "SAME canonical for ALL of them — never split one company across two CRM "
    "entries in the same meeting.\n"
    "- Do NOT match a mention to a short acronym fund (e.g. «SDF», «SVC», «XTX») "
    "purely by sound; require real contextual evidence, else null.\n"
