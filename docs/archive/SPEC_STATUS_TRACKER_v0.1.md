...
> **🗄️ АРХИВ (2026-06-05).** Эта версия заменена на
> [`SPEC_STATUS_TRACKER_v0.2.md`](../../SPEC_STATUS_TRACKER_v0.2.md) (в корне репы).
> v0.2 переиспользует движок Task Vector вместо собственного матчера/резолва людей.
> Функциональные требования v0.1 сохранены, изменилась только техника. Спека оставлена
> как исторический референс.
