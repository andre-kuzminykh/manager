...
> **🗄️ Архивная редакция (2026-06-05).** Историческая дизайнерская спека.
> Актуальная трассировка функциональности task lifecycle — через префикс
> `FR-CR-*` в коде (`app/slack_bot/`, `app/orchestrator/`, `app/sync/`).
