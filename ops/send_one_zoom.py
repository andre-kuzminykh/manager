...
def main() -> int:
    ...
    ap.add_argument(
        ...
        help=(
            ...
            "via _build_todo_section (FR-CR-05-119 / -163 filter). "
            "Bypasses ephemeral LLM extract entirely. Defensive "
            "DELETE at end still wipes those rows."
        ),
    )
    ap.add_argument(
    ...
    with session_scope() as session:
        ...
        # Build parent — FR-CR-05-189b: append «TODO:» trailer
