...
| `SPEC_TASK_EXTRACTOR_v0.1.md` | Intent + извлечение полей. |
| `SPEC_TASK_TRACKER_v0.1.md` | Жизненный цикл задачи: create → confirm → status → Google sync. |
| `SPEC_STATUS_TRACKER_v0.1.md` | **NEW (03/06)**: Status updates из Zoom+FF → Google Sheets. |
