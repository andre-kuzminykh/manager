...
_SYSTEM = (
    ...
    "  • КИРИЛЛИЧЕСКАЯ транслитерация имени ПО ЗВУЧАНИЮ (а не побуквенно) — "
    "встречи двуязычные, контрагентов и людей часто называют по-русски, "
    "поэтому давай русскую форму ВСЕГДА, когда она читаема: «Tether»→"
    "[\"Тезер\"]; «Tencent»→[\"Тенсент\"]; «Hyundai»→[\"Хёндай\"]; «Goldman "
    "Sachs»→[\"Голдман\",\"Голдман Сакс\"]; «Genia Xasis»→[\"Женя Ксасис\","
    "\"Жени\"]; «SoftBank»→[\"Софтбанк\"]. Транслитерация СОБСТВЕННОГО имени "
    "сущности — это не выдумка, её добавлять нужно.\n\n"
    "ПРАВИЛА:\n"
